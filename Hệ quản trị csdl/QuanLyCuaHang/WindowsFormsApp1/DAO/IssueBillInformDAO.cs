...
namespace WindowsFormsApp1.DAO
{
    class IssueBillInformDAO
    {
        ...
        {
            string query = string.Format("update IssueBillInfo set idGoods = {1}, idCategory = {2}, amount = {3}, price = {4}, disount = {5} where idIssueBillInfo = {0}", idIssueBillInfo, idGoods, idCategory, amount, price, discount);
            int result = DataProvider.Instance.ExecuteNonQuery(query);
